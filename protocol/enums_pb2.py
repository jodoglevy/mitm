...
_POKEMONNAME = _descriptor.EnumDescriptor(
  name='PokemonName',
  full_name='PGo.PokemonName',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_POKEMONNAME)

PokemonName = enum_type_wrapper.EnumTypeWrapper(_POKEMONNAME)
UNDEFINED = 0
BLUE = 1
RED = 2
YELLOW = 3
...
DESCRIPTOR.enum_types_by_name['PokemonName'] = _POKEMONNAME
